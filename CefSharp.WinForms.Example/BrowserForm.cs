...
namespace CefSharp.WinForms.Example
{
    ...
    {
        private const string DefaultUrlForAddedTabs = "http://localhost:5000";
        ...
        {
            AddTab("http://localhost:5000");
            var control = GetCurrentTabControl();
            control.Browser.RequestHandler = new FIRequestHandler(this);

            postman = new JObject();
            var login = JObject.Parse("{\"name\":\"登录\",\"request\":{\"method\":\"POST\",\"header\":[{\"key\":\"Content-Type\",\"name\":\"Content-Type\",\"value\":\"application/x-www-form-urlencoded\",\"type\":\"text\"},{\"key\":\"User-Agent\",\"value\":\"Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.70 Safari/537.36\",\"type\":\"text\"}],\"body\":{\"mode\":\"raw\",\"raw\":\"POST http://10.24.20.249:5200/sign-in HTTP/1.1\\r\\nHost: 10.24.20.249:5200\\r\\nConnection: keep-alive\\r\\nContent-Length: 123\\r\\nCache-Control: max-age=0\\r\\nOrigin: http://10.24.20.249:5200\\r\\nUpgrade-Insecure-Requests: 1\\r\\nContent-Type: application/x-www-form-urlencoded\\r\\nUser-Agent: Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/78.0.3904.70 Safari/537.36\\r\\nAccept: text/html,application/xhtml+xml,application/xml;q=0.9,image/webp,image/apng,*/*;q=0.8,application/signed-exchange;v=b3\\r\\nReferer: http://10.24.20.249:5200/login.html\\r\\nAccept-Encoding: gzip, deflate\\r\\nAccept-Language: zh-CN,zh;q=0.9\\r\\n\\r\\nIP=10.24.11.252&language=zh-CHS&Tenant=10000&Authenstrategy=UserPassword&username=ksf&password=11GA6e29zi2p0dYfP4t75A%3D%3D\"},\"url\":{\"raw\":\"{{baseUrl}}/sign-in?do-not-redirect=true\",\"host\":[\"{{baseUrl}}\"],\"path\":[\"sign-in\"],\"query\":[{\"key\":\"do-not-redirect\",\"value\":\"true\"}]}},\"response\":[]}");
            var items = new JArray();
            items.Add(login);
            postman.Add("item", items);
        }
